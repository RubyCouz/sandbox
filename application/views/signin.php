        ...
        <div class="col s12">
            ...
            <div class="row">
                <div class="input-field col s6">
                    ...
                    <span id="missingFirstname" class="error"></span>
                </div>
                <div class="input-field col s6">
                    ...
                    <span id="missingLastname" class="error"></span>
                </div>
            </div>
            <div class="row">
                <div class="input-field col s6">
                    ...
                    <span id="missingLogin" class="error"></span>
                </div>
                <div class="input-field col s6">
                    <input id="mail" type="email" class="white-text" name="mail_user" value="<?= set_value('mail_user') != NULL ? set_value('mail_user') : '' ?>">
                    <label for="mail">Adresse mail :</label>
                    <span id="missingMail" class="error"></span>
                </div>
            </div>
            <div class="row">
                <div class="input-field col s6">
                    <input id="password" type="password" class="white-text" name="password_user" value="<?= set_value('password_user') != NULL ? set_value('password_user') : '' ?>">
                    <label for="password">Mot de passe :</label>
                    <span id="missingPassword" class="error"></span>
                </div>
                <div class="input-field col s6">
                    ...
                    <span id="missingPasswordVerif" class="error"></span>
                </div>
            </div>
            <div class="row">
